...
<html>
  ...
  <body class="imagenDeFondo">
			...
			<div class="NombreDelUsuario">
                            ...
                            <form action="postMuro.php" method="post">
                                ...
                                <div class="muroContenido">
                                    <label>Â¿QuÃ© estas pensando?</label> <br>
        ...
        ?>
                ...
                <div>
                    <a href="/RedSocial/perfil.php?usuarioId=<?php echo $p->getRemitente()->getUsuarioId();?>">
				...
				<div class="NombreDelUsuario">
					<?php echo $p->getRemitente()->getNombre();?> &raquo;
                                        <a href="/RedSocial/perfil.php?usuarioId=<?php echo $p->getDestinatario()->getUsuarioId();?>">
